...
**
insheet using "metro_230624_stata.csv", comma names clear
...
**
reshape long var, i(year local ctprvn_cd ctp_eng_nm ctp_kor_nm) j(imsi)
**
gen cat=""
...
drop imsi ctprvn_cd
rename ctp_kor_nm CTP_KOR_NM
replace var="" if var=="-"
outsheet using "metro_230624_final.csv", comma names replace
**
